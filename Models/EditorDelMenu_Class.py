...
class EditarMenu:
    def __init__(self) -> None:
        ...
        menu_diccionario = {
            "Alimentos": [["ALIMENTO1", "ALIMENTO2"], [323.4, 123.4, 324]],
            "Bebidas": [["BEBIDA1", "BEBIDA2"], [543.55, 45.6, 100]],
        }

        with open(
            "Menu.json", "w", encoding="utf-8"
        ) as menu:  # Genera un archivo .json al cual se le puede escribir.
            json.dump(
                menu_diccionario, menu, indent=4, ensure_ascii=False
            )  # Vacia el diccionario en el archivo .json
