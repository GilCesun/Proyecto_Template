...
class Alimento:
    def __init__(self) -> None:
        ...
        self.listaAlimentos = diccionario_LeerMenu["Alimentos"][
            0
        ]  # Crear una lista solo de alimentos
        self.listaPrecios = diccionario_LeerMenu["Alimentos"][
            1
        ]  # Cr                                                    ear una lista solo de Precios
